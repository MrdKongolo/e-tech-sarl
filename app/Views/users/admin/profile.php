                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="overlay-edit">
                                                                            <a type="button" href="<?= base_url() ?>/dealing/<?= $quote->hash ?>/process" class="btn btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="Procéder">
                                                                                <i class="feather icon-check-circle"></i></a>
                                                                            <a type="button" href="<?= base_url() ?>/dealing/<?= $quote->hash ?>/done" class="btn btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Términer">
                                                                                <i class="feather icon-thumbs-up"></i></a>
                                                                            <a type="button" href="<?= base_url() ?>/cart-details/<?= $quote->hash ?>" class="btn btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="Détails">
