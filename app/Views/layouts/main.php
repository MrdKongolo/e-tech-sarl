...
<head>
    ...
    <title><?= $title ?? 'E-Tech SARL | Accueil' ?></title>
...
<body>
    ...
    <footer class="footer-area">
        <div class="copyright" style="background-color:#ebe9ef;">
            <div class="container">
                <marquee behavior="" direction="">
                    <div class="row">
                        <div class="col-lg-4 align-self-center">
                            <p class="copyright-text">
                            <a href="mailto:<?= $coords['email']?>"><i class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="">&nbsp;<?= $coords['email'] ?? 'Email' ?></span></a>
                            </p>
                        </div>
                        <div class="col-lg-4 align-self-center text-center">
                            <p class="copyright-text">
                                <a href="https://api.whatsapp.com/send?phone=243814590209" style="text-decoration:none"><i class="fab fa-whatsapp"></i>&nbsp;<?= $coords['phone'] ?? '+243 971 808 4889';?></a>
                            </p>
                        </div>
                    </div>
                </marquee>
        ...
        <div class="footer-widget">
            <div class="container">
                <div class="row footer-widget-wrapper pt-5">
