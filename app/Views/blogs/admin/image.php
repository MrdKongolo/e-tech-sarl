                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>/blogs">Les Réalisations</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5><?= $blog['title'] ?? "Image"?></h5>
                    </div>
                    <!-- [ breadcrumb ] end -->
                    <div class="card-body">
                        <?php $hidden = ['blog' => $blog['id']];?>
                        <?= form_open_multipart('blog-update-image','', $hidden) ?>
