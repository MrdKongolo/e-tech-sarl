...
<!-- Mirrored from live.themewild.com/retox/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 12:50:12 GMT -->
...
<head>
    ...
    <title>Retox - Creative Agency HTML5 Template</title>
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        ...
                        <div class="header-nav-right">
                            ...
                            <div class="header-btn">
                                <a href="#" class="theme-btn">GET QUOTE<i class="far fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#b6dfd8d0d9f6d3ced7dbc6dad398d5d9db"><i class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="d9b0b7bfb699bca1b8b4a9b5bcf7bab6b4">[email&#160;protected]</span></a>
                                </li>
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p class="copyright-text">
                            &copy; Copyright <span id="date"></span> <a href="#"> Retox </a> All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-lg-6 align-self-center">
